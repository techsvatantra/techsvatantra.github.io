...
import { ArrowLeft, CheckCircle, Heart, Users, Home, HeartHandshake as Handshake } from 'lucide-react';

const AboutUsPage = () => {
  const benefits = ["Relationship-focused matching", "Licensed and certified caregivers", "Personalized care plans", "Regular quality assessments", "Continuous caregiver training", "24/7 support and availability"];
  const fourPillars = [{
  ...
  return <div className="bg-background">
      <div className="relative bg-gradient-to-br from-primary to-teal-600 flex flex-col items-center justify-center p-4 pt-24 pb-12 overflow-hidden">
         <div className="absolute inset-0 z-0">
          <img className="w-full h-full object-cover opacity-20" alt="Comforting caregiver assisting an elderly person" src="https://images.unsplash.com/photo-1578925773717-a41e4a7fa4b0" />
        </div>
        <div className="relative z-10 w-full max-w-4xl mx-auto text-center">
          ...
          ease: 'easeOut'
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-4"> e2i home care</h1>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          delay: 0.2
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 px-4 md:px-10">
              {fourPillars.map((pillar, index) => <motion.div key={index} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
